    ...
    <x-backend.card>
        <x-slot name="body">
            <div x-data="{ user_id : false }">
                ...
                <x-forms.patch :action="route('admin.growtree.update', $growTree)" enctype="multipart/form-data">
                    @php(html()->model($growTree))
                    <div class="form-group row mb-3">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-md-5">
                            ...
                            @if ($growTree->diagram)
                                <div class="text-info py-1"><i class="fa fa-info-circle"></i> Leave empty to retain uploaded image.</div>
                                <img src="{{asset('storage/'. $growTree->diagram)}}" alt="" srcset="" class="img-fluid img-responsive" style="max-width:150px">                                
                            @endif
                        </div>
                    </div><!--form-group-->
                    <div class="form-group row mb-3">
