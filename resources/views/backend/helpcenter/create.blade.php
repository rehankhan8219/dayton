...
@section('title', __('Create Help Center'))
@section('page-title', __('Create Help Center'))
    ...
    <x-backend.card>
        <x-slot name="body">
            <div x-data="{ user_id : false }">
                <div class="row mb-3">
                    <div class="col-6">
                        <h4 class="card-title">@lang('Add a New Help Center')</h4>
                ...
                <x-forms.post :action="route('admin.helpcenter.store')" enctype="multipart/form-data">
                    <div class="form-group row mb-3">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <button class="col-md-2 btn btn-sm btn-primary float-right" type="submit">@lang('Create Help Center')</button>
                    </div>
                </x-forms.post>
            </div>
        </x-slot>
