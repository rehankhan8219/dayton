<div class="form-group row">
    ...
    <div class="col-md-4 mt-2">
        ...
        <div x-show="userType === '{{ $model::TYPE_ADMIN }}'">
            @include('backend.member.includes.partials.permission-type', ['type' => $model::TYPE_ADMIN])
        </div>

        <div x-show="userType === '{{ $model::TYPE_USER}}'">
            @include('backend.member.includes.partials.permission-type', ['type' => $model::TYPE_USER])
        </div>
    </div>
</div><!--form-group-->
