...
<x-backend.card>
    <x-slot name="body">
        <div class="row">
            <div class="col-6">
                <h4 class="card-title">@lang('Edit a Risk Calculator')</h4>
        ...
        <x-forms.patch :action="route('admin.riskcalculator.update', $riskCalculator)">
            @php(html()->model($riskCalculator))
            <x-backend.card>
                <x-slot name="body">
                    <div class="row mb-3">
                ...
                <x-slot name="footer">
                    <button class="btn btn-sm btn-primary float-right" type="submit">@lang('Update Risk Calculator')</button>
                </x-slot>
            </x-backend.card>
        </x-forms.patch>
    </x-slot>
