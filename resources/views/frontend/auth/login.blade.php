...
@section('content')
    <section class="long-c-t-a-wrapper">
        <x-forms.post :action="route($redirectBase.'.auth.login')" class="long-c-t-a">
                ...
                <div class="field-parent">
                    <div class="field">
                        ...
                        <div class="rectangle-parent">
                            ...
                            {{ html()->email('email')->class('input-unit')->placeholder('james@daytonfintech.com')->autofocus()->attribute('autocomplate', uniqid())->maxlength(191)->required() }}
                        </div>
                    </div>
                    <div class="field1">
                        ...
                        <div class="rectangle-group">
                            ...
                            {{ html()->password('password')->class('field-password')->placeholder(__('Enter Password'))->attribute('id', 'login_field_password')->attribute('autocomplate', uniqid())->maxlength(191)->required() }}
            ...
            <div class="dont-have-an-account-sign-up-wrapper">
                <div class="dont-have-an-container" id="dontHaveAn">
                    <span class="dont-have-an-account">
                        <span class="dont-have-an">Don't have an account? <x-utils.link :href="route('frontend.auth.register')" :text="__('Sign Up')"
                                class="sign-up sign-up1" /></span>
